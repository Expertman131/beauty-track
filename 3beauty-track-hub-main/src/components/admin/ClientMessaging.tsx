...
const ClientMessaging = () => {
  ...
  const [clients, setClients] = useState<Client[]>([
    { id: '1', name: 'Анна Петрова', email: 'anna@example.com', phone: '+7 (900) 123-45-67', lastVisit: '05.04.2025', image: 'https://randomuser.me/api/portraits/women/33.jpg' },
    { id: '2', name: 'Елена Сидорова', email: 'elena@example.com', phone: '+7 (900) 234-56-78', lastVisit: '12.04.2025', image: 'https://randomuser.me/api/portraits/women/44.jpg' },
    { id: '3', name: 'Марина Иванова', email: 'marina@example.com', phone: '+7 (900) 345-67-89', lastVisit: '18.04.2025', image: 'https://randomuser.me/api/portraits/women/55.jpg' },
  ]);
